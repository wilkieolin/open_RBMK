...
# Deck targets, recomputed 2026-09-24 for the Dollezhal-corrected carrier
# and clad.  graphite and fuel are unchanged by that correction.
expect = {"graphite": 89.59, "coolant": 3.65, "fuel": 2.90,
          "zirconium": 2.98, "gas": 0.87}
# Values printed by the DRAGON run (MIXTURESVOL).  STALE -- these are the
# 2026-09-22 numbers for the PRE-correction geometry and will not match until
# rbmk_cell_a3.x2m is re-run on a machine with the toolchain built.
